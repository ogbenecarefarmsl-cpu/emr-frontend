...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title ref={ref} className={cn("text-xl font-semibold leading-7 tracking-[-0.015em] text-slate-950", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Description ref={ref} className={cn("max-w-prose text-sm leading-5 text-slate-500", className)} {...props} />
));
